...
function calcular(){
    ...
    DibujarCruce(arrxy);
    document.getElementById("1er_ecuacion").innerHTML = "Ecuacion Uno: "+ a+"x + "+b+"y = "+c;
    document.getElementById("2da_ecuacion").innerHTML = "Ecuacion Dos: "+d+"x + "+e+"y = "+f;
    document.getElementById("resul_x").innerHTML = "x: "+ arrxy[0];
    document.getElementById("resul_y").innerHTML = "y: "+ arrxy[1];
	}
...
function verCuadricula(xnumpix_um, ynumpix_um, ancholinea){
	cd.beginPath();
